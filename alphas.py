...
class Alphas101(Alphas):
    ...
    #     df = -1 * correlation(rank(delta(log(volume), 2)), rank((self.close - self.open) / self.open), 6)
    ...
    #     return ((rank(correlation(sma(((self.open * 0.178404) + (self.low * (1 - 0.178404))), 13), sma(adv120, 13),
    #                               17)) < rank(
